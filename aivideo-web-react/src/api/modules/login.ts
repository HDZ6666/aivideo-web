import { Login, MenuApi } from "@/api/interface/index";
...
// * 获取菜单列表
export const getMenuList = (params: MenuApi.ReqMenuApi = { mode: "test" }) => {
	return http.get<MenuApi.ResMenuApi>(PORT1 + `/menu/list`, params);
};
