    ...
    <>
      ...
      >
        <Col span={24} md={12} xl={16} className="flex-1 text-center md:text-left">
          ...
          >
            本平台是一个基于GB28181-2016标准实现的网络视频平台，支持NAT穿透，支持海康、大华、宇视等品牌的IPC、NVR接入。
            支持国标级联，支持将不带国标功能的摄像机/直播流/直播推流转发到其他国标平台。
          </div>
          <button
      ...
      <PlatformModal title="平台信息" show={show} onCancel={() => setShow(false)} />
    </>
  );
}
