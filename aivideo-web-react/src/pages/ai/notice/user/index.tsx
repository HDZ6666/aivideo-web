...
import UserAdd, { UserAddProps } from './user-add';
import UserEdit, { UserEditProps } from './user-edit';
import { NoticeUser } from './user-modal';
...
export default function NoticeUserPage() {
  ...
  const [userAdd, setUserAdd] = useState<UserAddProps>({
    show: false,
    formValue: defaultUserValue,
    close: () => {
      setUserAdd((prev) => ({ ...prev, show: false }));
    },
    getTableData: () => {},
  });
  const [userEdit, setUserEdit] = useState<UserEditProps>({
    show: false,
    formValue: defaultUserValue,
    close: () => {
      setUserEdit((prev) => ({ ...prev, show: false }));
    },
    getTableData: () => {},
  });
  ...
  const onEdit = (user: NoticeUser) => {
    setUserEdit((prev) => ({ ...prev, show: true, formValue: { ...user } }));
  };
