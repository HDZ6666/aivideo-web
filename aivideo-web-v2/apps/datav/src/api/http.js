...
import { LoadingPlugin as Loading, MessagePlugin  as Message } from 'tdesign-vue-next';


let loadingInstance;
let loadingStatus = false;
if (process.env.NODE_ENV == 'development') {
    axios.defaults.baseURL = 'http://api.mmlzdsjpt.com/';
}
else if (process.env.NODE_ENV == 'debug') {
    axios.defaults.baseURL = 'http://127.0.0.1:9993/';
}
