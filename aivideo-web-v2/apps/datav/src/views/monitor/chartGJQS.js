...
const gjqsChartCreate=function($echart,id){
  ...
  gjqsOption={
    ...
    xAxis: [{
        ...
        boundaryGap: false,
        data: ['08-01 3时', '08-01 4时', '08-01 5时', '08-01 6时', '08-01 7时', '08-01 8时', '08-01 9时', '08-01 10时', '08-01 11时', '08-01 12时', '08-01 13时', '08-01 14时', '08-01 15时', '08-01 16时', '08-01 17时'],
    ...
    series: [{
          ...
          //   },
            ...
            data: [393, 438, 485, 631, 689,393, 438, 485, 631, 689, 824, 987, 1000, 1100, 1200]
        }
    ]
  };
  // 获取DOM元素并且进行初始化
