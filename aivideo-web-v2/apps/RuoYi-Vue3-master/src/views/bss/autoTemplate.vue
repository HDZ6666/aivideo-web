<template>
    <div class="app-container">
        <el-form
            ...
            label-width="68px"
        >
            <el-form-item label="模板标题" prop="resProCode">
                <el-input
            ...
            <el-form-item label="模板格式" prop="resProName">
                <el-input
            ...
            <el-form-item label="状态" prop="resProContent">
                <el-input
            ...
            <el-form-item label="创建人" prop="dataCatalog">
                <el-input
            ...
            <el-form-item label="最后修改时间" prop="resProClassifyId">
                <el-input
