<template>
    <div class="login">
        ...
        <el-form
            ...
            class="login-form"
        >
            <section v-if="loginComp === 'isSignIn'">
                <h3 class="title">门禁项目管理系统</h3>
                ...
                <div class="forgetBox">
                    <el-checkbox
                        ...
                        >记住密码</el-checkbox
                    >
                    <span class="forgetPassword" @click="loginComp = 'isForget'"
                        >忘记密码？</span
                    >
                </div>
            ...
            <section v-if="loginComp === 'isForget'">
                ...
                <div class="forgetBox">
                    <span class="forgetPassword" @click="loginComp = 'isSignIn'"
                        >返回登录</span
                    >
                </div>
            </section>
