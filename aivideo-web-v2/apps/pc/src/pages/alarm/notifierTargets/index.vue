...
import {addRules, delRules, getRules, listRules, updateRules} from '@/api/alarm/notifierTargets';
import type {RulesForm, RulesQuery, RulesVo} from '@/api/model/alarm/notifierTargetsModel';
