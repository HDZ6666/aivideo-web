    ...
    >
      <t-loading :loading="eLoading" size="small">
        <t-form ref="dictRef" label-align="right" :data="form" :rules="rules" label-width="120px" @submit="submitForm">
          ...
          <t-form-item label="告警级别" name="alarmLevel">
            <t-input v-model="form.alarmLevel" type="number" placeholder="请输入告警级别"/>
          </t-form-item>
          <t-form-item label="告警类型编号" name="alarmTypeId">
            <t-input v-model="form.alarmTypeId" placeholder="请输入告警类型编号"/>
          </t-form-item>
          <t-form-item label="告警类型名称" name="alarmTypeName">
            <t-input v-model="form.alarmTypeName" placeholder="请输入告警类型名称"/>
          </t-form-item>
          <t-form-item label="资源存储类型" name="assetStore">
            <t-input v-model="form.assetStore" placeholder="请输入资源存储类型"/>
          </t-form-item>
...
import {addRules, delRules, getRules, listRules, updateRules} from '@/api/alarm/datapoints';
import type {RulesForm, RulesQuery, RulesVo} from '@/api/model/alarm/datapointsModel';
