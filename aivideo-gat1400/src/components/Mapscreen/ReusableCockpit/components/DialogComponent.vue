  ...
  <div v-if="visible" class="dialog-container" @click.self="closeDialog">
    <div class="dialog-content">
      ...
      <div class="tab-content">
        ...
        <!-- 告警列表 Tab -->
        <AlertListTab v-if="activeTab === 0" :building-data="buildingData" />

         <!-- 新增摄像头详情 Tab -->
         <AlertDetailTab v-if="activeTab === 1" :building-data="buildingData" />
      </div>
    </div>
  </div>
</template>
...
import AlertDetailTab from "./tabs/AlertDetailTab.vue";//新增导入
