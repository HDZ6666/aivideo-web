    ...
    <div class="device-content">
      ...
      <div class="device-table">
        ...
        >
          ...
          <el-table-column prop="keepaliveTime" label="最近心跳" min-width="160"></el-table-column>
          <el-table-column prop="registerTime" label="最近注册" min-width="160"></el-table-column>
          ...
          <el-table-column label="操作" min-width="400" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                type="text"
                @click="showDevicePosition(scope.row)"
              >定位</el-button>
              <el-divider direction="vertical"></el-divider>
  ...
  methods: {
    ...
    transportChange: function(row) {
      ...
      this.$axios({
        method: "post",
        url:
          "/api/device/query/transport/" + row.deviceId + "/" + row.streamMode
      })
        .then(function(res) {})
        .catch(function(e) {});
    },
